    ...
    <div class="container">
      ...
      <div>
        <div class="mb-[16px] mt-[32px]">
          <h1 class="text-[14px] font-bold lg:text-[16px] xl:text-[18px]">Plan Yang Dipilih</h1>
        </div>
        <div class="bg-white p-3 lg:p-4 shadow-md rounded-lg flex gap-[16px] mb-[8px]">
          <div>
            <img
          ...
          <div>
            <h4 class="text-[14px] lg:text-[16px] xl:text-[18px] text-[#3A519D]">
              {{ name }} {{ mount }} Bulan
            </h4>
            <p class="text-[14px] lg:text-[16px] xl:text-[18px] font-semibold">Rp{{ price }}</p>
            <button
            ...
            >
              ...
              >
                ...
                <div v-for="plan in changePlan" :key="plan.mount" class="mb-3">
                  <div
        ...
        >
          <div @click="isOpen = !isOpen" class="flex justify-between w-full cursor-pointer">
            <button class="text-[14px] lg:text-[16px] xl:text-[18px] font-medium">Benefit</button>
            <div>
              <div
      ...
      <div>
        ...
        >
          <h1 class="mb-[8px] font-semibold text-[14px] lg:text-[16px] xl:text-[18px]">Payment Details</h1>
          <div class="mb-[24px]">
            <h1 class="text-[12px] lg:text-[14px] xl:text-[16px] flex justify-between mb-[8px]">
            ...
            >
              {{ promoActive }}
              <span class="text-[#FF6E79]">-Rp{{ discount }}</span>
            </h1>
            <h1 class="text-[12px] lg:text-[14px] xl:text-[16px] flex justify-between">
          ...
          <div class="">
            <h1 class="mb-[8px] font-semibold text-[14px] lg:text-[16px] xl:text-[18px]">Data Pengguna</h1>
            <div>
              ...
              <div class="rounded-lg border p-2">
                <div class="flex gap-2 mb-[12px]">
                  ...
                  <h1 class="text-[#00B2DA] text-[14px] lg:text-[16px] xl:text-[18px]">
                    Kode Promo (Opsional)
                  </h1>
                </div>
                ...
                <p v-if="promoError" class="text-[#FF6E79] text-[12px] lg:text-[14px] xl:text-[16px] pl-2">
                  {{ promoError }}
                </p>
              </div>
              <button
...
export default {
  ...
  mounted() {
    ...
    console.log("Parsed benefit:", this.price);
  },
  computed: {
    finalPrice() {
