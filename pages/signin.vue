  ...
  >
    ...
    <div>
      ...
      <div class="flex justify-end">
        <img class="w-[500px] md:hidden" src="/graphics/background-mobile-signup.webp" alt="" />
        <img class="w-[666px] lg:mt-[50px] xl:mt-[60px] hidden md:block" src="/graphics/background-desktop-signup.webp" alt="" />
      </div>
    </div>
  </div>
</template>
